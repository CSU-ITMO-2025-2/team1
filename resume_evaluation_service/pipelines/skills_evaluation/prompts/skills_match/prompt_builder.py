...
from .examples import skill_categorize_examples
from .human import skill_categorize_human_prompt as human
from .system import skill_categorize_system_prompt as system
