...
from .examples import course_extraction_examples
from .human import human_courses_extraction as human
from .system import system_course_extraction_prompt as system
