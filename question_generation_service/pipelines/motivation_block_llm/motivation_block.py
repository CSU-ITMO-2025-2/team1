...
from pipelines.prompts.motivation_block.prompt_builder import motivaion_block_full_prompt
from pipelines.pydantic_models.questions_blocks import MotivationBlock
