...
from .examples import personal_block_examples as examples
from .human import personal_block_human_prompt as human
from .system import personal_block_system_prompt as system
