...
from .examples import soft_skills_examples
from .human_prompt import human_prompt_soft_skills as human
from .system_prompt import system_soft_skills_prompt
